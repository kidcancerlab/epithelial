...
for (receiver_cell in all_cell_types) {
    if (is.list(nichenet_out[[receiver_cell]])) {
        ...
        plot_name <- plot_complex_heatmap(sub_nichenetr)

        ggsave(
            paste0("output/figures/nichenetr/nichenet_heatmap_main_",
                    str_replace(receiver_cell, "/", "_"),
                    ".pdf"),
            plot_name,
            width = 6,
        ...
        qs::qsave(
            plot_name,
            paste0(
                "output/figures/nichenetr/nichenet_heatmap_main_",
                str_replace(receiver_cell, "/", "_"),
                ".qs"
            )
        )
...
plot_name <-
    epi_myeloid_data %>%
    subset(coarse_cell_type %in% c("tumor", "epithelial", "Mono", "TAM", "IM", "AM")) %>%
    VlnPlot(
        features = c(
            "Fgf1_downstream",
            "Fgf2_downstream",
