...
Need to rewrite this to make the maunual curation conditional***
```{r}
...
r_dim_plot(lungs, group.by = "cell_type", split.by = "type", shuffle = TRUE)
r_dim_plot(lungs, "Integrated Stroma")
DimPlot(lungs, group.by = "annotations", split.by = "type", label = TRUE) + theme(legend.position = "none")

DimPlot(lungs, group.by = "cell_type", label = TRUE) + theme(legend.position = "none")
