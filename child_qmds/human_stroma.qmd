...
p4 <- r_feature_plot(epi, "KRT17")
p5 <- r_feature_plot(epi, "SFTPC", min.cutoff = 4)
p6 <- r_feature_plot(epi, "PDPN")
(p1 | p2 | p3) / (p4 | p5 | p6)

# Show genes from the basaloid signature identified in:
# https://doi.org/10.1038/s41467-022-33193-0
p1 <- r_feature_plot(epi, "FOSL1")
p2 <- r_feature_plot(epi, "CD24")
p3 <- r_feature_plot(epi, "ITGB8")
p1 | p2 | p3

# Show markers of activated AEC2
r_feature_plot(epi, "AREG")
r_feature_plot(epi, "TP63")
r_feature_plot(epi, "NTRK2")

Idents(epi) <- epi$seurat_clusters
epi_marks <- FindAllMarkers(epi, test.use = "DESeq2")
