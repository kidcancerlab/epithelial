...
#     if (!file.exists("../../../GenRef/sc_ref_datasets/human/hlca.qs")) {
#         options(
...
#         system(
#             "curl https://datasets.cellxgene.cziscience.com/3ab47484-a3eb-4f6a-beea-670e1a8fc1e8.h5ad --output ../../../GenRef/sc_ref_datasets/human/hlca.h5ad"
#         )
...
#         qs::qsave(hlca, "../../../GenRef/sc_ref_datasets/human/hlca.qs")

#     } else {
#         hlca <- qs::qread("../../../GenRef/sc_ref_datasets/human/hlca.qs")
#     }
...
if(!file.exists("output/rdata/met_lungs.qs")) {
    ...
    mets_meta <- tribble(
        ...
        "../../../Counts/S0058/outs/filtered_feature_bc_matrix/", "S0058", "Roberts Lab", "Metastasis", "cell",
        "../../../Counts/S0059/outs/filtered_feature_bc_matrix/", "S0059", "Roberts Lab", "Metastasis", "cell",
        "../../../Counts/S0217/filtered_feature_bc_matrix", "S0217", "Roberts Lab", "Metastasis", "nucleus",
        "../../../Counts/S0218/filtered_feature_bc_matrix", "S0218", "Roberts Lab", "Metastasis", "nucleus",
        "../../../Counts/SC069/filtered_feature_bc_matrix/", "SC069", "Roberts Lab", "Metastasis", "nucleus",
        "../../../Counts/SC072/filtered_feature_bc_matrix/", "SC072", "Roberts Lab", "Metastasis", "nucleus",
        "../../../Counts/SC073/filtered_feature_bc_matrix/", "SC073", "Roberts Lab", "Metastasis", "nucleus")
    ...
    mets_meta2 <- tribble(
        ...
        "../../../ExternalData/alsf/Soragni/SCPCS000522/SCPCL000854_filtered.rds", "SCPCS000523", "ALSF", "Metastasis", "cell",
        "../../../ExternalData/alsf/Soragni/SCPCS000522/SCPCL000854_filtered.rds", "SCPCS000524", "ALSF", "Metastasis", "cell",
        "../../../ExternalData/alsf/Soragni/SCPCS000522/SCPCL000854_filtered.rds", "SCPCS000525", "ALSF", "Metastasis", "cell",
        "../../../ExternalData/alsf/Soragni/SCPCS000522/SCPCL000854_filtered.rds", "SCPCS000526", "ALSF", "Metastasis", "cell")
