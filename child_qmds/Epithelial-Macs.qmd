...
DimPlot()
    ...
    macs$macs_assignment <- Idents(macs) %>%
        factor(levels = c("scarMac", "IFN-TAM",  "TAM", "Cycling", "cMonocyte",
        "ncMonocyte", "Interstitial", "Osteoclast", "Pre-DC", "DC1"))
...
mac_genes <- c(
    "Trem2", "Cd9", "Gpnmb", "Spp1", "Fn1", # Scar-associated, see https://doi.org/10.1038/s41586-019-1631-3
    "Ifit1", "Ifit2", "Cxcl10", # IFN-TAMs
     # TAMs are bland when compared to the rest of these populations
    "Top2a", "Hist1h1b", "Birc5",  # Cycling
    "Ly6c2", "Sell", "Ifitm6",  # cMonocyte
    "Itgal", "Ace", "Spn",  # ncMonocyte
    "Lyve1", "Mrc1", "Cd163",  # Tissue resident/interstitial
    "Nfatc1", "Mmp9", "Slc9b2", # Osteoclast-TAMs
    "Cd209a", "Ccr7", "Dcstamp", # Pre-DC
...
cluster_counts <-
    table(macs$obj_name, macs$macs_assignment) %>%
    as.data.frame() %>%
