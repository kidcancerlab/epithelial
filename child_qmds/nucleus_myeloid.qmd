...
qs::qsave(myeloid, "output/rdata/nucleus/myeloid.qs")
...
# This has only seurat clusters 0 and 1 from the original myeloid object above
qs::qsave(myeloid, "output/rdata/nucleus/myeloid_processed.qs")

pdf("output/figures/nucleus/myeloid_split_umap.pdf", height = 5, width = 15)
...
pdf("output/figures/nucleus/myeloid_pct_plot.pdf")
