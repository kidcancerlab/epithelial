...
epi_subtype_degs <- FindAllMarkers(epi)
...
merged_preds <- SingleR::SingleR(test = as.SingleCellExperiment(epi),
...
#                                     `6` = "endothelial",
#                                     `7` = "pAEC2"))
# qs::qsave(small_epi, "output/objects/small_epi.qs")

old_small_epi <- qs::qread("output/objects/small_epi.qs")
...
qs::qsave(small_epi, "output/objects/new_small_epi.qs") 

pdf("output/figures/DimPlots/epithelial_split_umap.pdf", width = 12, height = 4)
...
pdf("output/figures/epithelial_pct_plot.pdf")
